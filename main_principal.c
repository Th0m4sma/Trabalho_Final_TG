...
void menu_principal() {
    ...
    printf("][===-------[-(2)-Matriz-Adjacencia-]------===][\n");
    printf("][===-------[-(3)-Matriz-Incidencia-]------===][\n");
    printf("][===-------[-(4)-Lista--Adjacencia-]------===][\n");
    printf("][===--------[-(5)-Buscar-Vertices-]-------===][\n");
    printf("][===-----------[-(6)--SubGrafo-]----------===][\n");
    printf("][===-------------[-(7)-Ciclo-]------------===][\n");
    printf("][===-------[-(8)-Transformar--Grafo-]-----===][\n");
    printf("][===-----------[-(9)-Isomorfismo-]--------===][\n");
    printf("][===--------[-(10)-Operacao--Grafos-]-----===][\n");
    printf("][===------------[-(11)-Árvores-]----------===][\n");
    printf("][===---------[-(12)-Alterar-Grafo-]-------===][\n");
    printf("][===-----------[-(13)-AGENDADOR-]---------===][\n");
    printf("][===-------------[-(14)--SAIR-]-----------===][\n");
    linha_final();
}
...
int dfsCicloImprime(Grafo* g, int v, int visitado[], int pai[],
                    int* cicloInicio, int* cicloFim) {
    visitado[v] = 1;
...
// Lista de árvores abrangentes encontradas
